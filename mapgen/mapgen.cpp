...
void MapGen::draw()
{
    ...
    ImGui::RadioButton("plateMap noise", &info, 5);
    ImGui::RadioButton("plateMap2 noise", &info, 6);
    ImGui::RadioButton("plateDistance noise", &info, 7);
    ImGui::RadioButton("continentMap noise", &info, 8);
    ImGui::RadioButton("HeightMap noise", &info, 9);
    ImGui::RadioButton("plateDistanceValue", &info, 10);
    ImGui::RadioButton("plateScale", &info, 11);
    if(info!=m_info)
    {
        m_info=info;
        forceUpdate=true;
